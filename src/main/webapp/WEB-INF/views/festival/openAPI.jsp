...
<h1>예제 : 관광정보 조회하기</h1>
<ol>
	<li>요청 URL : http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList</li>
	<li>
		<h1>요청 메시지</h1>
		<ol>
...
<script type="text/javascript">
	...
	$('button').eq(1).on('click', function() {
		$.getJSON("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=" + serviceKey + "&areaCode=1&numOfRows=10&pageNo=1&contentid=2402006&MobileOS=ETC&MobileApp=TestApp&_type=json", function(areaCode) {
			// json 객체 내부 접근하기
