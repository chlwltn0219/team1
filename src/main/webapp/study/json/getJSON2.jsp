...
<ol>
	<li>Comma Separator ex) 10,총무부,서울</li>
	<li>XML</li>
	<li>JSON</li>
</ol>
...
<h1>AJAX (Asynchronous Javascript And XML) 비동기 자바 스크립트 데이터 통신 기술</h1>
<button class="btn btn-primary">getJSON dept</button>
<button class="btn btn-primary">getJSON depts</button>

<button class="btn btn-primary">getJSON + handlebars</button>
<button class="btn btn-primary">getJSON + handlebars</button>
...
<script type="text/javascript">
	...
	$('button').eq(0).on('click', function() {
		$.getJSON("/content/middleFrcst", function(data) {
			console.log(data);
			console.dir(data);
			
			var item = data.items.item;
			
			var li = '<li class="list-group-item">'+ item.regId + ", " + item.wf10 + ", " + item.wf3Am + "</li>";
