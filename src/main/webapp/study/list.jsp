...
<script async defer
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBwsdOL_w2QpqPbOnIEsqRH1E95ayFHtIw"
			...
			<div class="detail">
				<p>
					<ul>
						...
						<li><b>주소 : </b> <p class="detailtext"> {{addr1}}&nbsp;&nbsp;&nbsp;<a href="http://www.w3schools.com"><img src="/resources/img/location.png" style="width:25px; height:25px;"></a></p></li><br>
						<div id="map-canvas" style="width: 80%; height: 400px"></div><br>
					</ul>
				</p>
			</div>
