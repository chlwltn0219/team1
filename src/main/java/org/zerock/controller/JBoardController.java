...
public class JBoardController {
	...
	public String modifyPagingPOST(JBoardVO board, SearchCriteria cri, RedirectAttributes rttr) throws Exception {
	...
	public String registPOST(JBoardVO board, RedirectAttributes rttr) throws Exception {
